...
class BadExampleWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.bad_button.setStyleSheet("QPushButton { background-color: #ffcccc; padding: 10px; }")
        ...
        self.test_slider1.valueChanged.connect(lambda v: self.slider_label1.setText(str(v)))
...
class GoodExampleWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.good_button.setStyleSheet("QPushButton { background-color: #ccffcc; padding: 10px; }")
        ...
        self.test_slider2.valueChanged.connect(lambda v: self.slider_label2.setText(str(v)))
...
class ThreadPoolExampleWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.pool_button.setStyleSheet("QPushButton { background-color: #ccccff; padding: 10px; }")
    ...
    def start_batch_processing(self):
        ...
        self.pool_status.setText(f"并行处理 {task_count} 个任务 (使用 {worker_count} 个线程)")
